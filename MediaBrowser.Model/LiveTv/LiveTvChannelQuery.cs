...
namespace MediaBrowser.Model.LiveTv
{
    ...
    public class LiveTvChannelQuery
    {
        ...
        /// <summary>
        /// Gets or sets the number of items to skip within the results. Use for paging.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets specific whether to return news or not.
        /// </summary>
        /// <remarks>If set to null, all programs will be returned.</remarks>
        public bool? IsNews { get; set; }

        /// <summary>
        /// Gets or sets whether to return movies or not.
        /// </summary>
        /// <remarks>If set to null, all programs will be returned.</remarks>
